...
<template>
  <div class="bg-gray-100 dark:bg-gray-900 min-h-screen p-4">
    <nav class="flex justify-between items-center py-4">
      <NuxtLink to="/" class="text-2xl font-bold text-purple-600 dark:text-purple-300">
        Home
      </NuxtLink>
      <NuxtLink to="/anime" class="text-2xl font-bold text-purple-600 dark:text-purple-300">
        Anime
      </NuxtLink>
      <button
        ...
        <div class="mt-4">
          ...
          <div class="flex flex-wrap space-x-2 mt-2">
            <div
              ...
              class="bg-blue-200 text-blue-700 dark:bg-green-400 dark:text-green-900 rounded-full px-2 py-1"
            >
              {{ type }}
            </div>
          </div>
